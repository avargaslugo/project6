...
contract SupplyChain is ProducerRole, DistributorRole, RetailerRole, ConsumerRole{
  ...
  enum State 
  { 
    Produced,  // 0; if drug has been produced by a producer
    PaidFor, // 1; if the drug has been pair fot by the retailer
    Shipped,    // 2; if the drug has been shipped by the distributor
    Received,   // 3; if the drug has been received by the retailer
    Owned  // 4; if the drug has been bought by a final customer
    }
  ...
  struct Item {
    ...
    address ownerID;  // Metamask-Ethereum address of the current owner as the product moves through all stages
    address producerID; // Metamask-Ethereum address of the Producer
    string  producerName; // Producer Name
    string  producerPlantInformation;  // Producer Information
    string  producerPlantLatitude; // Producer Plant Latitude
    string  producerPlantLongitude;  // Producer Plant Longitude
  ...
  // Define 5 events with the same 5 state values and accept 'upc' as input argument
  ...
  // modifier to make sure that item with a given _upc is not part of the supply chain 
  ...
  // Define a modifier that checks if an item.state of a upc is PaidFor
  ...
  // Define a function 'produceDrug' that allows a producer to mark an item 'Produced'
  ...
  // define function that allows retailers to pay for a produced drug
  ...
  // Use the above modifers to check if the item is paidFor
